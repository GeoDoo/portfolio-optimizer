...
export const SEED_SQUADS: Squad[] = [
  {
    ...
    name: "Payments",
    members: [
      { id: id(), name: "Sarah",  role: "pm", seniority: "senior", allocation: 100, skill: 1   },
      { id: id(), name: "Alex",   role: "fe", seniority: "senior", allocation: 100, skill: 1   },
      { id: id(), name: "Jamie",  role: "fe", seniority: "mid",    allocation: 80,  skill: 0.7 },
      { id: id(), name: "Chris",  role: "be", seniority: "senior", allocation: 100, skill: 1   },
      { id: id(), name: "Morgan", role: "be", seniority: "senior", allocation: 100, skill: 1   },
    ],
  },
  {
    id: s2,
    name: "Growth",
    members: [
      { id: id(), name: "Taylor", role: "pm", seniority: "senior", allocation: 100, skill: 1   },
      { id: id(), name: "Jordan", role: "fe", seniority: "senior", allocation: 100, skill: 1   },
      { id: id(), name: "Casey",  role: "fe", seniority: "junior", allocation: 60,  skill: 0.5 },
      { id: id(), name: "Riley",  role: "be", seniority: "senior", allocation: 100, skill: 1   },
    ],
  },
  {
    id: s3,
    name: "Platform",
    members: [
      { id: id(), name: "Quinn",  role: "pm",  seniority: "lead",   allocation: 100, skill: 1   },
      { id: id(), name: "Avery",  role: "fe",  seniority: "mid",    allocation: 50,  skill: 0.7 },
      { id: id(), name: "Drew",   role: "be",  seniority: "senior", allocation: 100, skill: 1   },
      { id: id(), name: "Sam",    role: "be",  seniority: "senior", allocation: 100, skill: 1   },
      { id: id(), name: "Pat",    role: "sre", seniority: "senior", allocation: 80,  skill: 1   },
    ],
  },
];
