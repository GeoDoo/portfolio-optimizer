...
export const SEED_SQUADS: Squad[] = [
  {
    ...
    name: "Payments",
    members: [
      { id: id(), role: "pm", allocation: 100, skill: 1 },
      { id: id(), role: "fe", allocation: 100, skill: 1 },
      { id: id(), role: "fe", allocation: 80, skill: 0.8 },
      { id: id(), role: "be", allocation: 100, skill: 1 },
      { id: id(), role: "be", allocation: 100, skill: 0.9 },
    ],
  },
  {
    id: s2,
    ...
    members: [
      { id: id(), role: "pm", allocation: 100, skill: 1 },
      { id: id(), role: "fe", allocation: 100, skill: 1 },
      { id: id(), role: "fe", allocation: 60, skill: 0.7 },
      { id: id(), role: "be", allocation: 100, skill: 1 },
    ],
  },
  {
    ...
    members: [
      { id: id(), role: "pm", allocation: 100, skill: 1 },
      { id: id(), role: "fe", allocation: 50, skill: 0.6 },
      { id: id(), role: "be", allocation: 100, skill: 1 },
      { id: id(), role: "be", allocation: 100, skill: 1 },
      { id: id(), role: "be", allocation: 80, skill: 0.8 },
    ],
  },
];
